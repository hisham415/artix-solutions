...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var messageContainer = document.querySelector('.subscription-message'); // Updated this line

  form.addEventListener('submit', function (event) {
    event.preventDefault(); // Prevent the form from submitting normally

    // Display loading icon and hide submit button
    loadingIcon.style.display = 'inline-block';
    form.querySelector('.subscribe-btn').style.display = 'none'; 
    messageContainer.classList.remove('show');
    // Simulate submission delay (remove this in real implementation)
    setTimeout(function () {
      // Hide loading icon and show message
      form.querySelector('.subscribe-btn').style.display = 'inline-block'; 
